    ...
    E: Clone + Sync + Send + 'static,
{
    ...
    fn null_move_check(
        &self, s: &mut <E::G as Game>::S, depth: u8, player_to_move: i8, beta: Evaluation,
    ) -> Option<Evaluation> {
    ...
    fn iterative_search(
        &self, mut state: <E::G as Game>::S, max_depth: u8, player_to_move: i8, background: bool,
    ...
    E::G : TurnBasedGame,
{
    ...
    fn pretty_stats(
        &self, stats: &Stats, start: Instant, minimax: &ParallelExpectiMinimax<E>, depth: u8,
    ) -> String {
    ...
    E: Clone + Sync + Send + 'static,
{
    fn choose_move(&mut self, s: &<E::G as Game>::S) -> Option<<E::G as Game>::M> {
        ...
        self.eval.set_evaluated_player(player_to_move);
